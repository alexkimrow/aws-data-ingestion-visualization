...
QUERY_RESULTS_BUCKET = 's3://houston-query-result/'
MY_DATABASE = 'de_proj_database'
SOURCE_PARQUET_TABLE_NAME = 'houston_weather_data_parquet_tbl'
NEW_PROD_PARQUET_TABLE_NAME = 'houston_weather_data_parquet_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://houston-query-result-1'
